...
return [
    ...
    'info' => [
        ...
        'description' => 'RESTful API for a simple Task Management System.'
            ."\n\n".'Every endpoint except register and login requires a Sanctum bearer token. '
            .'Records are scoped to their owner: another user\'s projects and tasks answer 403.'
            ."\n\n".'Listings accept `page` and `per_page` (default 15, maximum 100). Task listings '
            .'also accept `status`, `priority` and `search`, which combine; an unknown filter '
            .'value returns 422 rather than an empty result.',
    ],
